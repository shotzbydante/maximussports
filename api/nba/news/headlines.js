...
function scoreItem(item) {
  ...
  if (/nba|basketball|dunk|three.pointer|playoffs|finals|mvp/.test(t)) s += 3;
  if (/espn|fox sports|ap news|yahoo|cbs|the athletic|nba\.com/.test((item.source || '').toLowerCase())) s += 2;
