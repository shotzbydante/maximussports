...
export function renderHTML(data = {}) {
  ...
  if (bestAts.length > 0) {
    atsRows = bestAts.slice(0, 5).map((team, i) => {
      ...
      return `<tr style="background-color:${i % 2 === 0 ? 'rgba(255,255,255,0.025)' : 'transparent'};">
...
<tr>
  <td style="padding:0 24px 10px;" class="section-td">
    <table role="presentation" cellpadding="0" cellspacing="0" width="100%" bgcolor="#0f1825"
      ...
      <tr>
        <td bgcolor="#0f1825" style="padding:16px 18px 8px;background-color:#0f1825;" class="card-td">
      ...
      <tr>
        <td bgcolor="#0f1825" style="padding:10px 14px 13px;background-color:#0f1825;border-top:1px solid rgba(255,255,255,0.05);">
