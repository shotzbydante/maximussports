...
const H = {
  pinning: {
    ...
    curiosity: ['🔥 Most Fans Check 3 Apps for Scores', '🔥 What Smart Fans Figured Out First', '⚠️ Still Refreshing Twitter for Scores?'],
  ...
  ats: {
    ...
    curiosity: ['🔥 Why Sharp Bettors Stopped Guessing', '🔥 The ATS Edge Hiding in Plain Sight', '⚠️ What Your Sportsbook Won\'t Show You'],
  ...
  oddsInsights: {
    ...
    curiosity: ['🔥 Why Lines Move — And What It Means', '⚠️ The Odds Intelligence Most Miss', '🔥 What Happens Before the Line Shifts?'],
...
const B = {
  pinning: [
    ['See the full dashboard', 'Live scores flow in real time', 'Your whole season, organized'],
  ...
  oddsInsights: [
    ...
    ['Live odds intel, always current', 'Line movement alerts', 'Smarter decisions, faster'],
  ],
  generalDemo: [
