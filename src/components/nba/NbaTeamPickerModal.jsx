/**
 * NbaTeamPickerModal — modal overlay for searching and pinning NBA teams.
...
import styles from './NbaTeamPickerModal.module.css';

const FREE_PIN_LIMIT = 3;

export default function NbaTeamPickerModal({ isOpen, onClose, pinnedTeams, addTeam, removeTeam, isPinned, isPro }) {
  ...
  const filteredTeams = useMemo(() => {
    if (!search.trim()) return NBA_TEAMS;
  ...
  return (
    <div className={styles.backdrop} onClick={(e) => { if (e.target === e.currentTarget) onClose(); }}>
      <div className={styles.modal} role="dialog" aria-modal="true" aria-label="Add NBA teams">
        <div className={styles.header}>
          <div>
            <h3 className={styles.title}>Add teams to your watchlist</h3>
            <p className={styles.subtitle}>Pin teams to track standings, odds, and intel.</p>
          </div>
        ...
        <div className={styles.searchWrap}>
          ...
          <input
            ref={inputRef}
            type="search"
            placeholder="Search teams (Lakers, Celtics, Warriors...)"
            value={search}
            ...
            return (
              ...
              >
                ...
                <div className={styles.teamInfo}>
                  ...
                  <span className={styles.teamDiv}>{team.conference} &middot; {team.division}</span>
                </div>
