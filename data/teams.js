/**
 * Shared team list (outside src/) for serverless APIs to avoid importing client src/ modules.
 * Single source of truth; src/data/teams.js re-exports for the app.
 */
const TEAM_LIST = [
  ...
  { slug: 'ole-miss-rebels', name: 'Ole Miss Rebels', conference: 'SEC', oddsTier: 'Work to do', keywords: 'Ole Miss Rebels Mississippi basketball' },
  { slug: 'mississippi-state-bulldogs', name: 'Mississippi State Bulldogs', conference: 'SEC', oddsTier: 'Work to do', keywords: 'Mississippi State Bulldogs basketball' },
  { slug: 'south-carolina-gamecocks', name: 'South Carolina Gamecocks', conference: 'SEC', oddsTier: 'Long shot', keywords: 'South Carolina Gamecocks basketball' },
  ...
  { slug: 'gonzaga-bulldogs', name: 'Gonzaga Bulldogs', conference: 'WCC', oddsTier: 'Lock', keywords: 'Gonzaga Bulldogs basketball' },
  { slug: 'utah-state-aggies', name: 'Utah State Aggies', conference: 'Mountain West', oddsTier: 'Lock', keywords: 'Utah State Aggies basketball' },
  { slug: 'saint-louis-billikens', name: "Saint Louis Billikens", conference: 'A-10', oddsTier: 'Should be in', keywords: "Saint Louis Billikens basketball" },
  { slug: 'saint-marys-gaels', name: "Saint Mary's Gaels", conference: 'WCC', oddsTier: 'Should be in', keywords: "Saint Mary's Gaels basketball" },
  { slug: 'miami-ohio-redhawks', name: 'Miami (Ohio) RedHawks', conference: 'MAC', oddsTier: 'Work to do', keywords: 'Miami Ohio RedHawks basketball' },
  { slug: 'santa-clara-broncos', name: 'Santa Clara Broncos', conference: 'WCC', oddsTier: 'Work to do', keywords: 'Santa Clara Broncos basketball' },
  { slug: 'new-mexico-lobos', name: 'New Mexico Lobos', conference: 'Mountain West', oddsTier: 'Work to do', keywords: 'New Mexico Lobos basketball' },
  { slug: 'san-diego-state-aztecs', name: 'San Diego State Aztecs', conference: 'Mountain West', oddsTier: 'Work to do', keywords: 'San Diego State Aztecs basketball' },
  { slug: 'vcu-rams', name: 'VCU Rams', conference: 'A-10', oddsTier: 'Work to do', keywords: 'VCU Rams basketball' },
  { slug: 'belmont-bruins', name: 'Belmont Bruins', conference: 'MVC', oddsTier: 'Long shot', keywords: 'Belmont Bruins basketball' },
  { slug: 'south-florida-bulls', name: 'South Florida Bulls', conference: 'AAC', oddsTier: 'Long shot', keywords: 'South Florida Bulls basketball' },
  ...
  { slug: 'mcneese-cowboys', name: 'McNeese Cowboys', conference: 'Southland', oddsTier: 'Long shot', keywords: 'McNeese Cowboys basketball' },
  ...
  { slug: 'loyola-chicago-ramblers', name: 'Loyola Chicago Ramblers', conference: 'A-10', oddsTier: 'Long shot', keywords: 'Loyola Chicago Ramblers basketball' },
  { slug: 'ohio-bobcats', name: 'Ohio Bobcats', conference: 'MAC', oddsTier: 'Long shot', keywords: 'Ohio Bobcats basketball' },
];
